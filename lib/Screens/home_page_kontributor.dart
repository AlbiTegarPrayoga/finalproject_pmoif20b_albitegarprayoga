...
class HomeKontributorPage extends StatefulWidget {
  final String username;
  HomeKontributorPage({required this.username});

  @override
  _HomeKontributorPageState createState() => _HomeKontributorPageState();
}

class _HomeKontributorPageState extends State<HomeKontributorPage> {
            ...
            Row(
              children: [
                ...
                IconButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context, MaterialPageRoute(builder: (context) => ProfileKontributorPage(),),);
                  },
                ),
              ],
            ),

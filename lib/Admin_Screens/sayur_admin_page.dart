...
import 'package:finalproject_pmoif20b_albitegarprayoga/Admin_Screens/edit_sayur_admin_page.dart';
import 'package:finalproject_pmoif20b_albitegarprayoga/Admin_Screens/homekategori_admin_page.dart';
import 'package:finalproject_pmoif20b_albitegarprayoga/Admin_Screens/tambah_sayur_admin_page.dart';
...
class SayurAdminPage extends StatefulWidget {
  const SayurAdminPage({ Key? key }) : super(key: key);

  @override
  _SayurAdminPageState createState() => _SayurAdminPageState();
}

class _SayurAdminPageState extends ResumableState<SayurAdminPage> {
  List widgets = [];
              ...
              children: [
                Align(
                  child: IconButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                        context, MaterialPageRoute(builder: (context) => TambahSayurAdminPage(),),);
                    },
                  ),
                ),
              ],
